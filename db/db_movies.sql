...
--
-- Host: localhost:8889
-- Generation Time: Apr 15, 2017 at 02:48 AM
...
CREATE TABLE `tbl_cast` (
  `cast_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_director` (
  `dir_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `tbl_L_md`;
CREATE TABLE `tbl_L_md` (
  `md_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  `movies_id` smallint(4) NOT NULL,
...
CREATE TABLE `tbl_movies` (
  `movies_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
...
(18, 'TH_Kick_Ass.jpg', 'Kick_Ass.jpg', 'nobImg.jpg', 'Kick-Ass', '2010', 'Dave Lizewski is an unnoticed high school student and comic book fan with a few friends and who lives alone with his father. His life is not very difficult and his personal trials not that overwhelming. However, one day he makes the simple decision to become a super-hero even though he has no powers or training', '117 min', 'Kick_Ass.mp4', '26.99'),
...
(26, 'TH_Taken2.jpg', 'Taken2.jpg', 'nobImg.jpg', 'Taken 2', '2012', 'Bryan Mills, the retired CIA agent, stopped at nothing to save his daughter Kim from Albanian kidnappers. The father of one of the kidnappers has sworn revenge and takes Bryan and his wife hostage during their family vacation in Istanbul. Bryan enlists his daughter to help them escape.', '92 min', 'Taken2.mp4', '26.99'),
(27, 'TH_TransformersDOTM.jpg', 'TransformersDOTM.jpg', 'nobImg.jpg', 'Transformers Dark Side Of The Moon', '2011', 'Autobots Bumblebee, Ratchet, Ironhide, Mirage (aka Dino), Wheeljack (aka Que) and Sideswipe led by Optimus Prime, are back in action taking on the evil Decepticons, who are eager to avenge their recent defeat. The Autobots and Decepticons become involved in a perilous space race between the United States and Russia, to reach a hidden Cybertronian spacecraft on the moon and learn its secrets, and once again Sam Witwicky has to come to the aid of his robot friends. The new villain Shockwave is on the scene while the Autobots and Decepticons continue to battle it out on Earth.', '154 min', 'TransformersDOTM.mp4', '26.99'),
(28, 'TH_UsualSuspects.jpg', 'UsualSuspects.jpg', 'nobImg.jpg', 'The Usual Suspects', '1995', 'Following a truck hijack in New York, five conmen are arrested and brought together for questioning. As none of them is guilty, they plan a revenge operation against the police. The operation goes well, but then the influence of a legendary mastermind criminal called Keyser Söze is felt. It becomes clear that each one of them has wronged Söze at some point and must pay back now. The payback job leaves 27 men dead in a boat explosion, but the real question arises now: Who actually is Keyser Soze? ', '106 min', 'UsualSuspects.mp4', '22.99');
...
CREATE TABLE `tbl_rating` (
  `rating_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
  `rating_name` varchar(35) NOT NULL,
  `rating_reason` varchar(100) NOT NULL,
...
INSERT INTO `tbl_rating` (`rating_id`, `rating_name`, `rating_reason`) VALUES
(1, '1 star', ''),
(2, '2 star', ''),
(3, '3 star', ''),
(4, '4 star', ''),
...
CREATE TABLE `tbl_studio` (
  `studio_id` smallint(4) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `tbl_timestamp`
--
...
CREATE TABLE `tbl_user` (
  ...
  `user_logs` varchar(200) NOT NULL,
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_lname`, `user_name`, `user_pass`, `user_email`, `user_level`, `user_ip`, `user_logs`, `user_timestamp`) VALUES
(1, 'sylvia', 'xiong', 'sylviaX', 'password', 'xiong.s@yahoo.com', '1', '::1', '1', '2016-03-13 12:31:33');

-- --------------------------------------------------------

--
-- Table structure for table `tel_rec`
--

DROP TABLE IF EXISTS `tel_rec`;
CREATE TABLE `tel_rec` (
  `rec_id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `rec_name` varchar(200) NOT NULL,
  `rec_type` varchar(200) NOT NULL,
  `rec_year` varchar(100) NOT NULL,
  `rec_reason` varchar(350) NOT NULL,
  PRIMARY KEY (`rec_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;

--
-- Dumping data for table `tel_rec`
--

INSERT INTO `tel_rec` (`rec_id`, `rec_name`, `rec_type`, `rec_year`, `rec_reason`) VALUES
(1, 'steps', 'dance', '2011', 'great');
